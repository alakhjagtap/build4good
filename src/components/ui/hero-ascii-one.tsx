...
export default function AnimationPage({ onStartClick }: { onStartClick?: () => void }) {
  useEffect(() => {
          ...
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Master Calculus and STEM subjects quickly through synchronized voice explanations, interactive 3D visuals, and real-time AI guidance natively in your browser.
              </p>
        ...
        <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 lg:gap-6 text-[8px] lg:text-[9px] font-mono text-white/50">
            ...
            <div className="hidden lg:flex gap-1">
              {[8, 14, 5, 12, 10, 6, 15, 7].map((height, i) => (
