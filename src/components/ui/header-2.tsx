...
export function Header({ onAuthAction }: { onAuthAction?: () => void }) {
		...
		>
			...
			>
				...
				<div className="hidden items-center gap-2 md:flex">
					...
					<Button variant="outline" onClick={onAuthAction}>Sign In</Button>
				</div>
				<Button size="icon" variant="outline" onClick={() => setOpen(!open)} className="md:hidden border-none hover:bg-transparent">
			...
			>
				...
				>
					...
					<div className="flex flex-col gap-2">
						<Button variant="outline" className="w-full" onClick={onAuthAction}>
							Sign In
						</Button>
					</div>
				</div>
